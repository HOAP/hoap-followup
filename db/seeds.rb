...
questions = [
  ...
  {page: 2, text: "Have you had any alcohol in the <b>last 12 months</b>?", values: ["Yes", "No"]},
  ...
  {page: 2, text: "How often do you have 12 or more Standard Drinks on one occasion?", values: ["Never", "Less than monthly", "Monthly", "Weekly", "Daily or almost daily"]},
  {page: 2, text: "How often during the last 12 months have you found that you were not able to stop drinking once you had started?", values: ["Never", "Less than monthly", "Monthly", "Weekly", "Daily or almost daily"]},
  {page: 2, text: "How often during the last 12 months have you failed to do what was normally expected of you because of drinking?", values: ["Never", "Less than monthly", "Monthly", "Weekly", "Daily or almost daily"]},
  {page: 2, text: "How often during the last 12 months have you needed a first drink in the morning to get yourself going after a heavy drinking session?", values: ["Never", "Less than monthly", "Monthly", "Weekly", "Daily or almost daily"]},
  {page: 2, text: "How often during the last 12 months have you had a feeling of guilt or remorse after drinking?", values: ["Never", "Less than monthly", "Monthly", "Weekly", "Daily or almost daily"]},
  {page: 2, text: "How often during the last 12 months have you been unable to remember what happened the night before because of your drinking?", values: ["Never", "Less than monthly", "Monthly", "Weekly", "Daily or almost daily"]},
  {page: 2, text: "Have you or someone else been injured because of your drinking?", values: ["No", "Yes, but not in the last 12 months", "Yes, during the last 12 months"]},
  {page: 2, text: "Has a relative, friend, doctor or other health worker been concerned about your drinking or suggested you cut down?", values: ["No", "Yes, but not in the last 12 months", "Yes, during the last 12 months"]},
  {page: 2, text: "Have you sought help to reduce your drinking?", values: ["No", "Yes, but not in the last 12 months", "Yes, during the last 12 months"]},
